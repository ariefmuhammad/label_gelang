...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'mysql3' => [
            'driver' => 'mysql',
            'url' => env('DATABASE_URL_THRID'),
            'host' => env('DB_HOST_THRID', '127.0.0.1'),
            'port' => env('DB_PORT_THRID', '3306'),
            'database' => env('DB_DATABASE_THRID', 'forge'),
            'username' => env('DB_USERNAME_THRID', 'forge'),
            'password' => env('DB_PASSWORD_THRID', ''),
            'unix_socket' => env('DB_SOCKET_THRID', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
            'prefix_indexes' => true,
        ...
        'mysql5' => [
            ...
            'unix_socket' => env('DB_SOCKET_FIVE', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
            'prefix_indexes' => true,
        ...
        'mysql7' => [
            ...
            'unix_socket' => env('DB_SOCKET_SEVEN', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
            'prefix_indexes' => true,
