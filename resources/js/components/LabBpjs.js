...
class LabBpjs extends Component {
    constructor(props) {
        super(props);
        this.state = {
            data: [],
    ...
    async getTindakan() {
        ...
        const res = await axios.get('/laboratorium/data/bpjs')
        const data = res.data
            ...
            return this.state.data.map(data => (
                <div key="1">
                    ...
                    <table className="mb-0 table table-bordered">
                      ...
                      <br></br>
                       <div>
                       <label className=""><b>Tindakan Laboratorium BPJS :</b></label>  
