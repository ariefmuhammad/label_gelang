...
class LabKlaimCovid extends Component {
    constructor(props) {
        super(props);
        this.state = {
            data: [],
            ...
            return this.state.data.map(data => (
                <div key="1">
                    ...
                    <table className="mb-0 table table-bordered">
                      ...
                      <br></br>
                       <div>
                       <label className=""><b>Tindakan Laboratorium KLAIM COVID :</b></label>  
                ...
                <div className="app-page-title">
                    <div className="page-title-wrapper">
                        <div className="page-title-heading">
                            ...
                            <div>
                                Laboratorium KLAIM COVID
                                <div className="page-title-subheading">
                                    Halaman ini berfungsi untuk mencetak Tindakan
                                    Pasien Laboratorium <b>KLAIM COVID.</b>
                                </div>
                            </div>
                        </div>
                    </div>
