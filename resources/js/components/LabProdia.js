...
class LabProdia extends Component {
    constructor(props) {
        super(props);
        this.state = {
            data: [],
    ...
    async getTindakan() {
        ...
        const res = await axios.get('/laboratorium/data/prodia')
        const data = res.data
            ...
            return this.state.data.map(data => (
                <div key="1">
                    ...
                    <table className="mb-0 table table-bordered">
                      ...
                      <br></br>
                       <div>
                       <label className=""><b>Tindakan Laboratorium Prodia :</b></label>  
                        ...
                        <div className="page-title-heading">
                            ...
                            <div>
                                ...
                                <div className="page-title-subheading">
                                    ...
                                    Pasien Laboratorium <b>Prodia.</b>
                                </div>
                            </div>
                        </div>
                    </div>
