...
<html>
<head>
    <title>Kwitansi Laboratorium Pasien</title>
    <style>
        body {
            font-size:15px;
            margin:10px;
...
@foreach($label as $i => $label)
    ...
    <div class="n"><b class="text-center">RINCIAN BIAYA LABORATORIUM</b></div>
    <hr size="4" width="52%" color="black">  
...
<table style="margin:0;margin-left:13px;width:100%">
  ...
  <tr>
    <td>
    <b style="font-family:sans-serif;">Total Tarif</b>
    </td>
    <td> :
    </td>
    <td>
