...
<table style="margin:0;margin-left:13px;margin-right:13px;width:100%">
  <tr>
    <th class="widthno">No.</th>
    <th>Jenis Tindakan & Tarif</th>
  </tr>
  ...
  @endforeach
  <tr>
   <td class="widthno"><b>Total</b></td>
   <td><b>Rp. {{$TOTAL_TARIF}}<b></td>
  </tr>
</table>
<div class="t"><b class="text-right">Pontianak, {{$TANGGAL_MASUK}}</b></div>
@endforeach
