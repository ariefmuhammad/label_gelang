...
@foreach($label as $i => $label)
    ...
    <div class="l"><b style="font-family:sans-serif;" class="text-center"> KEMENTRIAN PENDIDIKAN DAN KEBUDAYAAN<br> RUMAH SAKIT UNIVERSITAS TANJUNGPURA</b></div>
...
<div class="row rowl">
  <div class="column">
    <p><b style="font-family:sans-serif;">No RM</b></p>
    <p><b style="font-family:sans-serif;">Nama</b></p>
    <p><b style="font-family:sans-serif;">Tanggal Lahir</b></p>
    <p><b style="font-family:sans-serif;">Dokter</b></p>
    <p><b style="font-family:sans-serif;">Status</b></p>
  </div>
  <div class="column2">
  ...
  <div class="column3">
  <p><b style="font-family:sans-serif;">{{$label->NORM}}</b></p>
  <p><b style="font-family:sans-serif;">{{$label->NAMA}}</b></p>
  <p><b style="font-family:sans-serif;">{{ $label->TANGGAL_LAHIR}}</b></p>
  <p><b style="font-family:sans-serif;">{{$DOKTER}}</b></p>
  <p><b style="font-family:sans-serif;">{{$STATUS}}</b></p>
  </div>
</div>
...
<table style="margin:0;margin-left:0px;margin-right:0px;width:100%">
  ...
  <tr>
    <td style="font-family:sans-serif;font-size:5px;" class="widthno2">
      {{++$no}}.
    </td>
    <td>
  ...
  <tr>
   ...
   <td style="font-family:sans-serif;font-size:5px;"><b>Rp. {{$TOTAL_TARIF}}<b></td>
  </tr>
</table>
